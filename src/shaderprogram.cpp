...
void initShaders(){
    spLambert=new ShaderProgram("./src/shaders/v_lambert.glsl",NULL,"./src/shaders/f_lambert.glsl");
    spConstant=new ShaderProgram("./src/shaders/v_constant.glsl",NULL,"./src/shaders/f_constant.glsl");
    spSimplest=new ShaderProgram("./src/shaders/v_simplest.glsl",NULL,"./src/shaders/f_simplest.glsl");
    spTextured = new ShaderProgram("./src/shaders/v_textured.glsl", NULL, "./src/shaders/f_textured.glsl");
}
